...
- **Then** returns 400 with `type="https://dcm-project.github.io/problems/invalid-argument"`
...
- **Then** returns 409 with `type="https://dcm-project.github.io/problems/already-exists"`
...
- **Then** returns 409 with `type="https://dcm-project.github.io/problems/already-exists"` and detail indicating the name conflict
...
- **Then** returns 422 with `type="https://dcm-project.github.io/problems/unprocessable-entity"`
...
- **Then** returns 500 with `type="https://dcm-project.github.io/problems/internal"`
...
- **Then** returns 400 with `type="https://dcm-project.github.io/problems/invalid-argument"` and detail indicating workers count must be >= 1
...
- **Then** returns 400 with `type="https://dcm-project.github.io/problems/invalid-argument"` (exceeds 63-char K8s limit)
...
- **Then** returns 404 with `type="https://dcm-project.github.io/problems/not-found"`
...
- **Then** returns 400 with `type="https://dcm-project.github.io/problems/invalid-argument"` and detail mentioning allowed range 1-100
...
- **Then** returns 400 with `type="https://dcm-project.github.io/problems/invalid-argument"` and detail mentioning minimum value is 1
...
Tests the shared domain-error-to-RFC-9457 mapping used by all handlers.
...
- **When** each error is converted to an RFC 9457 response
- **Then** the mapping is: `https://dcm-project.github.io/problems/invalid-argument` -> 400, `https://dcm-project.github.io/problems/not-found` -> 404, `https://dcm-project.github.io/problems/already-exists` -> 409, `https://dcm-project.github.io/problems/unprocessable-entity` -> 422, `https://dcm-project.github.io/problems/internal` -> 500, `https://dcm-project.github.io/problems/unavailable` -> 503
...
- **When** converted to an RFC 9457 response
- **Then** the `detail` field does NOT contain the original K8s error text
- **And** `type="https://dcm-project.github.io/problems/internal"` and a generic `title` is used
